    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeEmailSuccess ? "Zmienio Email."
                : "";
        ...
        public async Task<ActionResult> ChangeEmail(ChangeEmailViewModel model)
        {
            ...
            var user = UserManager.FindById(User.Identity.GetUserId());
            Profile p = db.Profiles.Single(o => o.UserName.Equals(user.UserName));
            p.UserName = model.NewAddress;
            db.Entry(p).State = EntityState.Modified;
            db.SaveChanges();
           
            user.UserName = model.NewAddress;
            user.Email = model.NewAddress;
